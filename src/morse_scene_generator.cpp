...
typedef actionlib::SimpleActionServer<lifelong_benchmarking::SceneAction> Server;
...
void execute(const lifelong_benchmarking::SceneGoalConstPtr& goal, Server* as)
{
