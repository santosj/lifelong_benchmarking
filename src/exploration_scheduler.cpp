...
#include <lifelong_benchmarking/SceneAction.h>
...
typedef actionlib::SimpleActionClient<lifelong_benchmarking::ExecutionAction> ExecutionClient;
typedef actionlib::SimpleActionClient<lifelong_benchmarking::PlanAction> PlanClient;
typedef actionlib::SimpleActionClient<lifelong_benchmarking::SceneAction> SceneClient;
...
int main(int argc,char *argv[])
{
    ...
    ros::ServiceClient saveGridService = n.serviceClient<lifelong_benchmarking::SaveLoad>("/fremenGrid/save");
    printf("%i\n",debug++);
    ...
    lifelong_benchmarking::SceneGoal scene_goal;
    lifelong_benchmarking::PlanGoal plan_goal;
    lifelong_benchmarking::ExecutionGoal exec_goal;
    printf("%i\n",debug++);
    ...
    do
    {
        ...
        if (plans[position] > 0 && plans[position] < 4 && stop == false)//godmode
        {
            ...
            if (ac_plan.getState() == actionlib::SimpleClientGoalState::SUCCEEDED)
            {
                ...
                /*save the map*/
                lifelong_benchmarking::SaveLoad saveInfo;
