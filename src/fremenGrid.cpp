...
bool loadcompareGrid(lifelong_benchmarking::SaveLoad::Request  &req, lifelong_benchmarking::SaveLoad::Response &res)
{
    int changes = 0;
...
bool visualizeRoi(lifelong_benchmarking::Visualize::Request  &req, lifelong_benchmarking::Visualize::Response &res)
{
