...
#include "lifelong_benchmarking/EditValue.h"
...
typedef actionlib::SimpleActionServer<lifelong_benchmarking::PlanAction> Server;
...
bool editGrid(lifelong_benchmarking::EditValue::Request  &req, lifelong_benchmarking::EditValue::Response &res)
{
...
void reachableCallback(const lifelong_benchmarking::Reachable::ConstPtr &msg)
{
...
void execute(const lifelong_benchmarking::PlanGoalConstPtr& goal, Server* as)
{
    ...
    lifelong_benchmarking::PlanResult result;
