...
#include <lifelong_benchmarking/ExecutionAction.h>
#include <lifelong_benchmarking/PlanAction.h>
...
#include "lifelong_benchmarking/Reachable.h"
#include "lifelong_benchmarking/InjectPose.h"
...
lifelong_benchmarking::AddView measure_srv;
lifelong_benchmarking::Visualize visualize_srv;

ros::ServiceClient *measure_client_ptr, *visualize_client_ptr, *pose_client_ptr;

typedef actionlib::SimpleActionClient<move_base_msgs::MoveBaseAction> MoveBaseClient;
typedef actionlib::SimpleActionServer<lifelong_benchmarking::ExecutionAction> Server;
typedef actionlib::SimpleActionClient<lifelong_benchmarking::PlanAction> PlanClient;//replan!

actionlib::SimpleActionClient<strands_navigation_msgs::MonitoredNavigationAction> *ac_nav_ptr;
actionlib::SimpleActionClient<lifelong_benchmarking::PlanAction> *ac_plan_ptr;
...
void execute(const lifelong_benchmarking::ExecutionGoalConstPtr& goal, Server* as)
{
    ...
    lifelong_benchmarking::ExecutionFeedback feedback;          //action feedback
    lifelong_benchmarking::ExecutionResult execution_result;    //action result
    lifelong_benchmarking::Reachable reachable_points;          //message used to update reachability grid
    ...
    if(goal->godmode)
    {
        ...
        lifelong_benchmarking::InjectPose pose_srv;
...
int main(int argc,char *argv[])
{
    ...
    //Publishers
    ros::Publisher reach_pub = nh.advertise<lifelong_benchmarking::Reachable>("/reachable_points", 10);
...
;
    ...
    ros::ServiceClient measure_client = n.serviceClient<lifelong_benchmarking::AddView>("/fremenGrid/depth");
    measure_client_ptr = &measure_client;

    //inject pose service client
    ros::ServiceClient pose_client = n.serviceClient<lifelong_benchmarking::InjectPose>("/inject_pose");
    pose_client_ptr = &pose_client;

    //vizualize client
    ros::ServiceClient visualize_client = n.serviceClient<lifelong_benchmarking::Visualize>("/fremenGrid/visualize");
